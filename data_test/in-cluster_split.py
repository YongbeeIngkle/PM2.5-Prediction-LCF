...
from data_process.spatial_validation import ClusterGrid, TargetGrid
...
def _save_source_cmaqs(source_coord):
...
if __name__=='__main__':
    ...
    _save_source_cmaqs(source_target_set["source"]["cmaq_id"])
