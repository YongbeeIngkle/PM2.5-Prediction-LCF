...
def main():
    ...
    source_cmaq = source_data['cmaq_id'].unique().tolist()
    ...
    for sp in mn_range_list:
        ...
        kgbr_file = open(f"results/results-minmax-east-wa/kgbr-results", "a+")
        kliep_gbr_file = open(f"results/results-minmax-east-wa/kliep-gbr-results", "a+")
        rulsif_gbr_file = open(f"results/results-minmax-east-wa/rulsif-gbr-results", "a+")
        nnw_gbr_file = open(f"results/results-minmax-east-wa/nnw-gbr-results", "a+")
