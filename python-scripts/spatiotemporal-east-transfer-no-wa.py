...
def main():
    ...
    # source_data = monitoring_df[monitoring_df['rid'].isin([3,5,9])]
    source_data = monitoring_df[monitoring_df['cmaq_x'] > 0.0]
    ...
    for sp in mn_range_list:
        ...
        # kgbr_file = open(f"results/results-minmax-east-no-wa/kgbr-results", "a+")
        # kliep_gbr_file = open(f"results/results-minmax-east-no-wa/kliep-gbr-results", "a+")
        # rulsif_gbr_file = open(f"results/results-minmax-east-no-wa/rulsif-gbr-results", "a+")
        nnw_gbr_file = open(f"results/results-minimax-east-no-wa/nnw-gbr-results", "a+")
